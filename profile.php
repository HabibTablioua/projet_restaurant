...
?>
  ...
  <body>
    ...
    <section class="checkout-form">
      <h1 id="cart" style="text-align: center;margin-bottom: 1%;font-size: 48px;font-weight: 700;font-family: 'Beau Rivage', cursive;">Account Informations</h1>
      <form id="modifyUser">
        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" value="<?php echo $fetch_info["nom"]; ?>" class="form-control" name="firstname" id="firstname" required>
          </div>
          <div class="col">
            <span>Last Name</span>
            <input type="text" value="<?php echo $fetch_info["prenom"]; ?>" class="form-control" name="lastname" id="lastname" required>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <span>Phone Number</span>
            <input type="number" value="<?php echo $fetch_info["telephone"]; ?>" class="form-control" name="number" id="number" required>
          </div>
          <div class="col">
            <span> Email address</span>
            <input type="email" value="<?php echo $fetch_info["email"]; ?>" class="form-control" name="email" id="email" required>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <span>Address</span>
            <input type="text" value="<?php echo $fetch_info["adresse"]; ?>" class="form-control" name="addres" id="addres" required>
          </div>
          <div class="col">
            <span>Account Creation Date :</span>
            <input type="text" class="form-control" value="<?php echo $fetch_info["date_aujaurd"]; ?>" name="creatc" id="creatc" disabled>
          </div>
        </div>
        </div>
        <br>
        <div style="text-align:center;">
          ...
          <button id="btnmodfa" style="align-items: center;width: 220px;" class="btn btn-outline-light btn-fw btn-lg"><b><i class="fa-solid fa-pen-to-square"></i> &nbsp;&nbsp;&nbsp;Modify</b></button>
        </div>
      </form>
      <div style="text-align:center;margin-top:1rem;">
        <a href="modifypass.php" style="align-items: center;width: 260px;" class="btn btn-outline-light btn-fw btn-lg"><b><i class="fa-solid fa-key"></i> &nbsp;&nbsp;&nbsp;Change Password</b></a>
        <a id="btndelete" style="align-items: center;width: 260px;margin-left:0.3rem;" class="btn btn-outline-light btn-fw btn-lg"><b><i class="fa-solid fa-trash-can"></i> &nbsp;&nbsp;&nbsp;Delete Account</b></a>
      </div>
    </section>
