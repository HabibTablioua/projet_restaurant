...
if(isset($_POST['inresid'])){
$idres = mysqli_real_escape_string($conn,$_POST['inresid']);
//echo $idres;
}
?>
...
<body>
        ...
        <li><a class="nav-link scrollto active" href="home.php">Home</a></li>
          ...
          <li class="dropdown"><a href="#"><span><?php  echo $fetch_info['nom']; ?></span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="#"><div><i class="bi bi-cart-check-fill"></i>&nbsp;&nbsp; Orders</div></a></li> 
  ...
  <section class="p-5">
    ...
    <div style="align-items: center;display: flex;justify-content: center;">
      <form id="frmrestb">
        <input type="hidden" name="idres" id="nbp" value="<?= $idres; ?>">
        <div class="col">
  ...
  <script>
    ...
    $(document).on('click','#deletemeal', function(e){
        ...
        //add new order
        $(document).on('submit', '#frmrestb',function (e){
          //alert('here');
            e.preventDefault();      
            var formData = new FormData(this);
            formData.append("frmrestb", true); 
            $.ajax({
                type: "POST",
                url: "crud.php",
                data: formData,
